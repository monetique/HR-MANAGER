...
// Remplacer le contenu complet du composant
const newContent = `// frontend/src/components/LeaveBalanceCard.jsx
    ...
    <div style={cardStyle}>
      ...
      <div style={headerStyle}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '12px', color: '#6b7280' }}>
          <span style={{ width: '7px', height: '7px', borderRadius: '50%', display: 'inline-block', background: '#f59e0b' }}/>
          <span>Déduction sur N-1</span>
          <span style={{ color: '#374151' }}>|</span>
          <span>🎁 {formatDate(next_grant_date)}</span>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', padding: '12px' }}>
        ...
        <div style={blockStyle(true, true)}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
            <span style={{ fontSize: '11px', fontWeight: 600, color: '#9ca3af', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
              📁 N-1
            </span>
            <span style={{ fontSize: '11px', fontWeight: 600, padding: '2px 8px', borderRadius: '20px', background: 'rgba(245,158,11,0.2)', color: '#f59e0b' }}>
              Actif
            </span>
          </div>
          <div style={{ fontSize: '32px', fontWeight: 700, lineHeight: 1, marginBottom: '4px', color: low ? '#ef4444' : '#f59e0b' }}>
            {fmt(n1Remaining)}
        ...
        {/* N — Prochain versement */}
        <div style={blockStyle(!nGrantPending, false)}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
            <span style={{ fontSize: '11px', fontWeight: 600, color: '#9ca3af', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
              ✅ N
            </span>
            <span style={{ fontSize: '11px', fontWeight: 600, padding: '2px 8px', borderRadius: '20px', background: nGrantPending ? 'rgba(255,255,255,0.08)' : 'rgba(59,130,246,0.2)', color: nGrantPending ? '#6b7280' : '#3b82f6' }}>
              {nGrantPending ? '—' : 'Actif'}
            </span>
          </div>
          <div style={{ fontSize: '32px', fontWeight: 700, lineHeight: 1, marginBottom: '4px', color: nGrantPending ? '#4b5563' : '#3b82f6' }}>
            {fmt(nTotal)}
            <span style={{ fontSize: '14px', fontWeight: 400, marginLeft: '4px', color: '#9ca3af' }}>j</span>
          </div>
          <div style={{ fontSize: '12px', color: '#6b7280', marginBottom: '4px' }}>
          ...
          <div style={barBg}>
            <div style={{
              ...
              borderRadius: '99px',
              background: nGrantPending ? '#374151' : '#3b82f6',
              transition: 'width 0.5s ease',
            }} />
          </div>
        </div>
...
console.log('OK LeaveBalanceCard.jsx patche');
